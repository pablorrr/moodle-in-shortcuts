...
$plugin->version = 20190720;
$local_requires = 20140512; 		// Version 2.7 - See http://docs.moodle.org/dev/Moodle_Versions

$plugin->component = 'local_gws_query_practice';  //frankenstyle plugin name, strongly recommended. It is used for installation and upgrade diagnostics. 
